...
const s_textId = '565441684';
const s_pageId = '1672297851';
const s_replyId = '1602657806';
const s_sheetId = '1N-btee_uhQoFkXac9sw4Lo6JgJqUOT58wMvBsmeiuKA';
const s_sheetName = 'Filtered';
...
const v_mainHtml = `
    <div id="c_inputDiv" class="c-area">
        <form id="c_form" onsubmit="c_submitButton.disabled = true; v_submitted = true; alert('A carrier pigeon has flown off with your letter!');" method="post" target="c_hiddenIframe" action="https://docs.google.com/forms/d/e/${s_formId}/formResponse"></form>
    </div>
...
function getComments() {
    ...
    // Get the data
    const url = `https://docs.google.com/spreadsheets/d/${s_sheetId}/gviz/tq?sheet=${s_sheetName}`;
